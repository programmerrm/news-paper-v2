  ...
  return (
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex gap-2 sm:gap-3">
        ...
        <Link target="_blank" href={webinfo?.webInfo?.twiter || ""} className="text-blue group w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-gray-100 hover:bg-red-600 flex items-center justify-center transition">
          <span className="text-[18px] group-hover:text-white transition">
