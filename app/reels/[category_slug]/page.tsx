...
export default async function Page({ params }: CategoryReelProps) {
    const { category_slug } = await params;
    const reelsData = await getFetchData(`/videos/reelgalleries/${category_slug}`);
    const categories = reelsData?.categories;
